...
{
    public partial class FrmTarifaRegistrar : Form
    {
        public FrmTarifaRegistrar()
        {
            InitializeComponent();
        }
        ...
        private void FrmTarifaRegistrar_Load(object sender, EventArgs e)
        {
        ...
        private void pnl_registroDetalle_Paint(object sender, PaintEventArgs e)
        {
