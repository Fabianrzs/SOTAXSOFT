...
{
    public partial class FrmEliminaTaxi : Form
    {
        private TaxiService service;
        public FrmEliminaTaxi()
        {
            InitializeComponent();
        ...
        private void BtnEliminar_Click(object sender, EventArgs e)
        {
            if (ValidateChildren())
            {
                MessageBox.Show(service.EliminarTaxi(TxtPlaca.Text), "Información", MessageBoxButtons.OK, MessageBoxIcon.Information); LoaderTablet();
            }
        }
    }
}
